...
moduleAdapter.SetPic(this.getContentElement('info','txtUrl').getInputElement().$.id,this.toadapter);moduleAdapter.AppendLinks(this.getContentElement('Link', 'txtUrl').getInputElement().$.id);
